<template>
    <div class="head">
        ...
        ></v-text-field>
        <div class="d-flex">
            <a href="/marks" style="color: #292b61; font-family: gilroy-reguar;">
                <div>
            ...
            <a href="/achieves" style="color: #292b61; font-family: gilroy-reguar;">
                <div>
        ...
        <img v-if="currentRoute != '/home'" type="button" :src="require('@/assets/img/Back.svg')"
             @click="$router.go(-1)">
    </div>
</template>
